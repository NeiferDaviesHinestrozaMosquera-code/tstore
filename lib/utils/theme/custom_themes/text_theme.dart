...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith( fontSize: 18, fontWeight: FontWeight.w600, color: Colors.black),
    labelMedium: const TextStyle().copyWith( fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5)),
  );
